...
(deftest parse-uri
  ...
  (is (= {:address "0x1234" :value "1e18" :gas "5000" :chain-id 1} (eip681/parse-uri "ethereum:0x1234@1?value=1e18&gas=5000")))
  (is (= {:address "0x1234" :value "1e18" :gas "5000" :chain-id 2} (eip681/parse-uri "ethereum:0x1234@2?value=1e18&gas=5000")))
  (is (= nil (eip681/parse-uri "ethereum:0x1234@2/transfer?value=1e18&gas=5000"))))
...
(deftest generate-uri
  ...
  (is (= "ethereum:0x1234?value=1" (eip681/generate-uri "0x1234" {:value (money/bignumber 1)})))
  (is (= "ethereum:0x1234?value=1000000000000000000" (eip681/generate-uri "0x1234" {:value (money/bignumber 1e18)})))
  (is (= "ethereum:0x1234?value=1&gas=100" (eip681/generate-uri "0x1234" {:value (money/bignumber 1) :gas (money/bignumber 100) :chain-id 1})))
  (is (= "ethereum:0x1234@3?value=1&gas=100" (eip681/generate-uri "0x1234" {:value (money/bignumber 1) :gas (money/bignumber 100) :chain-id 3})))
